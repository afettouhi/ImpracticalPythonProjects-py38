...
class Satellite(pg.sprite.Sprite):
    ...
    def __init__(self, background):
        ...
        self.image_sat = pg.image.load("../data/satellite.png").convert()
        self.image_crash = pg.image.load("../data/satellite_crash_40x33.png").convert()
        ...
        self.thrust = pg.mixer.Sound('../data/thrust_audio.ogg')
...
class Planet(pg.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image_mars = pg.image.load("../data/mars.png").convert()
        self.image_water = pg.image.load("../data/mars_water.png").convert()

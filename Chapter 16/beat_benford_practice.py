...
def main():
    ...
    """
    # load vote data
    c_votes = load_data('../data/Clinton_votes_Illinois.txt')
    j_votes = load_data('../data/Johnson_votes_Illinois.txt')
    s_votes = load_data('../data/Stein_votes_Illinois.txt')
    t_votes = load_data('../data/Trump_votes_Illinois.txt')
    ...
    with open('../data/fake_Illinois_counts.txt', 'w') as f:

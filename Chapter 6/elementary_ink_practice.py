...
fake_text = docx.Document('../data/fakeMessage.docx')
fake_list = []
...
real_text = docx.Document('../data/realMessageChallenge.docx')
real_list = []
...
doc = docx.Document('../data/template.docx')
...
doc.save('../data/ciphertext_message_letterhead.docx')

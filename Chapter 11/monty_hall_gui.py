...
class Game(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.parent = parent
        self.img_file = '../data/all_closed.png'  # current image of doors
    ...
    def create_widgets(self):
        ...
        img = tk.PhotoImage(file='../data/all_closed.png')
    ...
    def win_reveal(self):
        ...
        self.img_file = ('../data/reveal_{}.png'.format(self.reveal))
        self.update_image()
        ...
        self.img_file = '../data/all_closed.png'
    ...
    def show_final(self):
        ...
        if switch_doors == 'y':
            ...
            if new_pick == self.winner:
                self.img_file = '../data/money_{}.png'.format(new_pick)
                self.pick_change_wins += 1
            else:
                self.img_file = '../data/goat_{}.png'.format(new_pick)
                self.first_choice_wins += 1
        elif switch_doors == 'n':
            if self.choice == self.winner:
                self.img_file = '../data/money_{}.png'.format(self.choice)
                self.first_choice_wins += 1
            else:
                self.img_file = '../data/goat_{}.png'.format(self.choice)
                self.pick_change_wins += 1
